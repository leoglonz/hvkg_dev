...
SEEDS = [42, 0, 259068, 355549, 369813, 467073, 488127, 561897, 593786, 831920,
905678, 998244, 222779, 41371, 649186, 287910, 510955, 490956, 955276, 319515] #, 806017]
...
def run_full_experiment(seed: int, output_dir: str = "out"):
    ...
    while total_cost < EVAL_BUDGET * cost_func(1):
        ...
        # Fit the model
        if USE_SC:
            train_model_adam(mll=mll, online=True)
        else:
