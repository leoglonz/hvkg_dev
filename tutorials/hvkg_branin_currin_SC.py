...
while total_cost < EVAL_BUDGET * cost_func(1):
    ...
    mll, model = initialize_model(normalize(train_x_kg, BC.bounds), train_obj_kg, train_sc_kg)  #### Add SC data
...
plt.savefig("/projects/mhpi/leoglonz/project_silmaril/iclr_examples/HV-KG/figs/hvkg1.png")
